...
if($obj->is_ajax()){
	...
	$bodymsg .= 'Thank you, <br> FleurDeLis';
	
	$email = 'aakrati@perceptive-solutions.com';
	$mail	= new PHPMailer(); 
	$mail->IsSMTP(); 
	$mail->SMTPSecure = "tls";
	$mail->Host = SMTP_HOST; 
	...
	$mail->SetFrom("info@fleurdelis.org", "Fleur De Lis"); //From address of the mail
	// put your while loop here like below,
	$mail->Subject = "Contact us enquiry"; //Subject of your mail

...
if($_REQUEST['action']=="delete")
{
	...
	mysql_query("update testimonials set image='' where id='".$_REQUEST['id']."'"); 
	echo "<script> window.location.href='testimonials_update.php?msg=deleted&id='+'".$id."';</script>";
	exit;
}
if(isset($_REQUEST['update'])){

	if($_FILES['image']['name']!=''){
		$uploaddir = '../images/testimonials/' . $_FILES['image']['name'];
...
function fn_del(id)
{
  ...
  {
	  window.location.href='testimonials_update.php?action=delete&id='+id;
  }
}
                ...
                <tr>
                  ...
                  <td align="left" valign="top" class="right_top_top_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <form name="software" action="testimonials_update.php" method="post" enctype="multipart/form-data">
...
if($res['image'] != '') { echo "<br />" . $res['image'];
	?>&nbsp;<img src="images/b_drop.png" alt="" width="16" height="16" border="0" onclick="fn_del('<?php echo $res['id']; ?>')" /> <? } ?>
  ...
  <tr>
   ...
   <tr>
    ...
    <input type="button" value="Back" class="inputBtn" onclick="document.location.href='testimonials.php';" />
    </td>
   </tr>
</table>
</form>

...
if($_SESSION['admin_id']==""){
	...
	if($_POST['task']=="add_manufacture"){
			...
			$sqlq="INSERT INTO `makes_model`(`year`,`make_model_text`,`parent_id`)VALUES('$year','$model_name','$manu_name')";
				...
				header("location:models.php?msg=Data Has Been Added Successully");
	exit;
			}
...
<script type="text/javascript">
	...
	function chkreg(){
		...
		var fullname = $("input[name=model_name]").val();
		
		$("#errormsg").html("");
		$("#errormsg").fadeIn();
		
		if(fullname=="" || fullname=='Your Name'){
		   $("#errormsg").html("Enter Model Name");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td align="left" valign="middle" class="middle_bg_blu"><h4>Add New Model</h4></td>
  ...
  <tr>
   ...
   <tr>
    <td width="20%" align="left" valign="top" class="page-tile tr-color"><strong>Manufacture Name</strong></td>
    <td width="80%" align="left" valign="top"  class="tr-color"><select name="manu_name" class="input-type">
  ...
  <tr>
    <td width="20%" align="left" valign="top" class="page-tile tr-color"><strong>Model Name</strong></td>
    <td width="80%" align="left" valign="top"  class="tr-color"><input name="model_name" type="text" value="" class="input-type"/></td>
  </tr>
   ...
   <tr>
    ...
    <input type="submit" name="update" value="Add New Model" class="inputBtn" />
    </td>
   </tr>
</table>
</form>

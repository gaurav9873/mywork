...
if(isset($_REQUEST['action'])&& $_REQUEST["action"]=="delete"){
  $deletequery=mysql_query("delete from  downloads where id='$id'") ;
}
?>
...
function fn_del(id)
{
  ...
  {
	  window.location.href='download.php?action=delete&id='+id;
  }
}
//-->
</script>
                ...
                <tr>
                  ...
                  <td align="left" valign="top" class="right_top_top_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                     ...
                     <tr>
                      <td height="12" align="right"><input type="button" value="Add" class="inputBtn2" onclick="window.location ='download-update.php'" /></td>
                    </tr>
                    <tr>
...
?>
                        <tr>
                          ...
                          <td height="30" class="border_row_right"><a href="download-update.php?id=<?php echo $res['id']; ?>"><span><img src="images/edit_img.jpg" alt="" width="56" height="19" border="0" /></span></a></td>
                        </tr>
<?php
	}
?>   

...
//echo $getrandno;
 ...
 $zipcodes=$_POST['zipcode'];
  ...
  $sqlupdate="update purchase_cardetail set trimname='".$trims."', prefcolor='".$colors."', specialpref='".$specialprif."', ordervehicle='".$orders."', tradein='".$tradein."', caroption='".$caroption."', paymenttype='".$payments."', zipcode='".$zipcodes."' where id ='".$uid."'"; 
			
			
mysql_query($sqlupdate);
header("location:buyer_cardetail.php?msg=Brand Has Been Updated Successully");
...
$sql="SELECT * FROM purchase_cardetail WHERE id= '".$_REQUEST['id'] ."'";
	$req = tep_db_query($sql);
	$row= tep_db_fetch_array($req);
	//echo $row['prefcolor'];
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td align="left" valign="middle" class="middle_bg_blu"><h4>Add Buyer Car Detail</h4></td>
...
<input name="trimname" type="radio" class="radio_form" value="<?php echo $row['trimname']; ?>" checked="checked" /></div>
...
<div class="color_chick-botton">
  <label>
  <input type="checkbox" value="Black" class="chkboxx" id="checkbox" name="prefcolor" value="<?php echo $row['prefcolor']; ?>">
  </label>
</div>
...
<div class="color_chick-botton">
  <label>
  <input type="checkbox" value="Blue" class="chkboxx" id="checkbox" name="prefcolor" value="<?php echo $row['prefcolor']; ?>">
  </label>
</div>
...
<div class="color_chick-botton">
  <label>
  <input type="checkbox" value="Brown" class="chkboxx" id="checkbox" name="prefcolor" value="<?php echo $row['prefcolor']; ?>">
  </label>
</div>
...
<div class="color_chick-botton">
  <label>
  <input type="checkbox" value="Gray" class="chkboxx" id="checkbox" name="prefcolor" value="<?php echo $row['prefcolor']; ?>">
  </label>
</div>
...
<div class="color_chick-botton">
  <label>
  <input type="checkbox" value="Red" class="chkboxx" id="checkbox" name="prefcolor" value="<?php echo $row['prefcolor']; ?>">
  </label>
</div>
...
<div class="color_chick-botton">
  <label>
  <input type="checkbox" value="Silver" class="chkboxx" id="checkbox" name="prefcolor" value="<?php echo $row['prefcolor']; ?>">
  </label>
</div>
...
<div class="color_chick-botton">
  <label>
  <input type="checkbox" value="White" class="chkboxx" id="checkbox" name="prefcolor" value="<?php echo $row['prefcolor']; ?>">
  </label>
</div>
...
<div class="helf_form">
  <label>
  <textarea id="specialpref" class="helf_for" name="specialpref"><?php echo $row['specialpref']; ?></textarea>
  </label>
</div>
</div>
<div class="preferred_colors">
...
<div class="frontrak_cont">
<div class="trim_name_text_RADIO">
<input type="radio" checked="checked" value="no" class="radio_form" name="ordervehicle" value="<?php echo $row['ordervehicle']; ?>"></div>
...
<div class="frontrak_cont">
<div class="trim_name_text_RADIO">
<input type="radio" value="yes" class="radio_form" name="ordervehicle" value="<?php echo $row['ordervehicle']; ?>"></div>
...
<input type="text" onblur="checkzipcode(this.value);" class="zip_Code_form" name="zipcode" value="<?php echo $row['zipcode']; ?>">

...
$sql = "SELECT * FROM footer_links WHERE `id` = '".$_REQUEST['id'] ."'";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td align="left" valign="top" class="right_top_top_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <form name="software" action="footer_links_update.php" method="post" enctype="multipart/form-data">
  ...
  <tr>
    <td width="20%" align="left" valign="top" class="page-tile tr-color"><strong>Link Name</strong></td>
    <td width="80%" align="left" valign="top"  class="tr-color"><input name="name" type="text" value="<?php echo $res['name']; ?>" class="input-type"/></td>
  </tr>
  <tr>
   <td align="left" valign="top" class="page-tile tr-color"><strong>Link Path </strong></td>
   <td align="left" valign="top" class="tr-color"><input name="link" type="text" value="<?php echo $res['link']; ?>" class="input-type"/></td>
  </tr>
   ...
   <tr>
    ...
    <input type="button" value="Back" class="inputBtn" onclick="document.location.href='footer_links.php';" />
    </td>
   </tr>
</table>
</form>

...
if(isset($_REQUEST['update'])){
	...
	if($_FILES['file_name']['name']!=''){
		$uploaddir = '../images/downloads/' . $_FILES['file_name']['name'];
		move_uploaded_file($_FILES['file_name']['tmp_name'], $uploaddir);
		$small_image_str = ", file_name = '". $_FILES['file_name']['name'] ."'";
	}
  ...
  $sql = "/* Update downloads */
   ...
   SET
	...
	header("location:download-update.php?id=".$_REQUEST['id']."&msg=" . $msg);
	exit;
...
$sql = "SELECT * FROM downloads WHERE `id` = '".$_REQUEST['id'] ."'";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td align="left" valign="top" class="right_top_top_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td align="left" valign="middle" class="middle_bg_blu"><h4>Download</h4></td>
                    ...
                    <tr>
                      ...
                      <form name="downloads" action="download-update.php" method="post" enctype="multipart/form-data">
  ...
  <tr>
   ...
   <tr>
   <td align="left" valign="top" class="page-tile"><strong>PDF Upload</strong></td>
     <td align="left" valign="top" class="logo-padding"><input name="file_name" type="file" />
     <?php
if($res['file_name'] != '') echo "<br />" . $res['file_name'];
	?></td>
  </tr>
   ...
   <tr>
    ...
    <td align="left" valign="middle">
        ...
        <input type="button" value="Back" class="inputBtn" onclick="document.location.href='download.php';" />
    </td>
   </tr>
</table></form>
</td>

<?php
	...
	if($_POST['task']=="update"){
		...
		$sqlupate  = "update makes_model set year='$year',make_model_text='$manu_name' where id='$userid'"; 
			mysql_query($sqlupate);
			
	header("location:manufacture.php?msg=Data Has Been Edited Successully");
	exit;
		}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td align="left" valign="middle" class="middle_bg_blu"><h4>Edit Manufacture </h4></td>
  ...
  <tr>
    ...
    <td align="left" valign="top"  class="tr-color"><input name="manu_name" type="text" value="<?php echo $res['make_model_text']; ?>" class="input-type"/></td>
  </tr>
  <tr>
   ...
   <tr>
    ...
    <input type="submit" name="update" value="Update Manufacture" class="inputBtn" />    </td>
   </tr>
</table>
</form>
</td>

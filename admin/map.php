...
if(isset($_REQUEST['action'])&& $_REQUEST["action"]=="delete"){
  $deletequery=mysql_query("delete from  map where id='".$_GET['id']."'") ;
}
if(isset($_REQUEST['action'])&& $_REQUEST["action"]=="delete_img"){
$sql = "UPDATE map SET image = '' WHERE id ='".$_REQUEST['id']."' " ;
...
function fn_del(id)
{
  ...
  {
	  window.location.href='map.php?action=delete&id='+id;
  }
}
function img_del(id)
{
  ...
  {
	  window.location.href='map.php?action=delete_img&id='+id;
  }
}
//-->
</script>
                ...
                <tr>
                  ...
                  <td align="left" valign="top" class="right_top_top_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                     ...
                     <tr>
                      <td height="12" align="right">&nbsp;<!--<input type="button" value="Add" class="inputBtn2" onclick="window.location ='map_update.php'" />--></td>
                    </tr>
                    <tr>
                      <td align="center" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="31%" height="30" class="border_row_left"><strong>Title </strong></td>
                          <td width="29%" height="30" class="border_row_left"><strong>Images </strong></td>
                          <td width="20%" height="30" class="border_row_left"><strong>Delete </strong></td>
                          
                          <td width="20%" height="30" class="border_row_right"><strong> Edit </strong></td>
                        </tr>
...
?>
		...
		<img src="../images/map/<?php echo $res['image']; ?>" width="80" height="100" alt="" border="0" />&nbsp;&nbsp;
		...
		?>  
                          ...
                          <td height="30" class="border_row_right"><a href="map_update.php?id=<?php echo $res['id']; ?>"><span><img src="images/edit_img.jpg" alt="" width="56" height="19" border="0" /></span></a></td>
                        </tr>
<?php
	}
?>   

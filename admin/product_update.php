...
if($_REQUEST['action']=="delete")
{
    $uploaddir = '../images/products/';
	  $id=$_REQUEST['id'];	
	mysql_query("update products set image='' where id='".$_REQUEST['id']."'"); 
	echo "<script> window.location.href='product_update.php?msg=deleted&id='+'".$id."';</script>";
	exit;
}
...
if(isset($_REQUEST['update'])){
	...
	if($_FILES['image']['name']!=''){
		$uploaddir = '../images/products/' . $_FILES['image']['name'];
...
function fn_del(id)
{
  ...
  {
	  window.location.href='product_update.php?action=delete&id='+id;
  }
}
                ...
                <tr>
                  ...
                  <td align="left" valign="top" class="right_top_top_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <form name="software" action="product_update.php" method="post" enctype="multipart/form-data">
...
if($res['image'] != ''){ echo "<br />" . $res['image'];
  ...
  <tr>
   ...
   <tr>
    ...
    <input type="button" value="Back" class="inputBtn" onclick="document.location.href='product.php';" />
    </td>
   </tr>
</table>
</form>

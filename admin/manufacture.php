...
if(isset($_REQUEST['action'])&& $_REQUEST["action"]=="delete" && $_REQUEST['id']!=""){
	...
	header("location:manufacture.php?msg=Data Has Been Deleted Successully");
	exit;
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td align="left" valign="middle" class="middle_bg_blu"><h4> Manufacture Management</h4></td>
                     ...
                     <tr>
                      <td height="12" align="right"><?php if($_REQUEST[msg]!='') { ?><div align="center"><?php echo $_REQUEST[msg];?></div><?php } ?><input type="button" value="Add" class="inputBtn2" onclick="window.location='add_manufacture.php'" /></td>
                    </tr>
                    <tr>
                      <td align="center" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
						 <td height="30" class="border_row_left"><?php echo $sn; ?></td>
                          ...
                          <td height="30" class="border_row_right"><a href="edit_manufacture.php?id=<?php echo $res["id"]; ?>">Edit </a>/ <a href="?action=delete&id=<?php echo $res["id"]; ?>" onclick="return confirm('Are you sure want to delete this users');">Delete</a></td>
                        </tr>
<?php
	$sn++ ;}
?>   

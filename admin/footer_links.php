...
if(isset($_REQUEST['action'])&& $_REQUEST["action"]=="delete"){
  $deletequery=mysql_query("delete from  footer_links where id='$id1'") ;
}
?>
...
function fn_del(id)
{
  ...
  {
	  window.location.href='footer_links.php?action=delete&id='+id;
  }
}
//-->
</script>
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td align="left" valign="middle" class="middle_bg_blu"><h4>Other Links</h4></td>
                     ...
                     <tr>
                      <td height="12" align="right"><input type="button" value="Add" class="inputBtn2" onclick="window.location ='footer_links_update.php'" /></td>
                    </tr>
                    <tr>
                      <td align="center" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="30%" height="30" class="border_row_left"><strong>Link Name </strong></td>
                          <td width="30%" height="30" class="border_row_left"><strong>Link </strong></td>
...
?>
                        <tr>
                          ...
                          <td height="30" class="border_row_left"><?php echo $res['link']; ?></td>
                          ...
                          <td height="30" class="border_row_right"><a href="footer_links_update.php?id=<?php echo $res['id']; ?>"><span><img src="images/edit_img.jpg" alt="" width="56" height="19" border="0" /></span></a></td>
                        </tr>
<?php
	}
?>   

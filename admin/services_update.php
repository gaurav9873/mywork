...
if($_REQUEST['action']=="delete")
{
	...
	mysql_query("update services set small_image='' where id='".$_REQUEST['id']."'"); 
	echo "<script> window.location.href='services_update.php?msg=deleted&id='+'".$id."';</script>";
	exit;
}
...
/*	echo "<pre>";
	...
	if($_FILES['small_image']['name']!=''){
		$uploaddir = '../images/services/' . $_FILES['small_image']['name'];
	...
	if($_FILES['large_image']['name']!=''){
		$uploaddir = '../images/services/' . $_FILES['large_image']['name'];
...
function fn_del(id)
{
  ...
  {
	  window.location.href='services_update.php?action=delete&id='+id;
  }
}
...
$sql = "SELECT * FROM services WHERE `id` = '".$_REQUEST['id'] ."'";
                ...
                <tr>
                  ...
                  <td align="left" valign="top" class="right_top_top_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td align="left" valign="middle" class="middle_bg_blu"><h4>Services</h4></td>
                    ...
                    <tr>
                      ...
                      <form name="services" action="services_update.php" method="post" enctype="multipart/form-data">
											<input type="hidden" name="id" value="<?php echo $_REQUEST['id']; ?>" />
                      <table width="100%" border="0" cellspacing="0" cellpadding="5">
                       <tr>
   <td width="21%" align="left" valign="top" class="page-tile tr-color"><strong>image</strong></td>
   <td width="79%" align="left" valign="top" class="tr-color logo-padding"><input name="small_image" type="file" />
     <?php
		if($res['small_image'] != '') { echo "<br />" . $res['small_image'];
	?>&nbsp;<img src="images/b_drop.png" alt="" width="16" height="16" border="0" onclick="fn_del('<?php echo $res['id']; ?>')" /> <? } ?></td>
                       </tr>
...
?>
  ...
  <tr>
   ...
   <!--<tr>
    ...
    <td align="left" valign="top"><textarea name="small_descriptions" cols="" rows="" class="textarea2"><?php echo $res['small_descriptions']; ?></textarea></td>
   </tr>-->
 
  <tr>
   <td align="left" valign="top" class="page-tile tr-color"><strong>Service descriptions </strong></td>
   <td align="left" valign="top" class="tr-color">
    
<textarea name="large_descriptions" cols="" rows="" class="textarea3"><?php echo $res['large_descriptions']; ?></textarea>
   </td>
  </tr>
   ...
   <tr>
    ...
    <td align="left" valign="middle">
        ...
        <input type="button" value="Back" class="inputBtn" onclick="document.location.href='services.php';" />
    </td>
   </tr>
</table>
</form>

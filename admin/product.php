...
if(isset($_REQUEST['action'])&& $_REQUEST["action"]=="delete"){
  $id=$_REQUEST['id'];	
  $deletequery=mysql_query("delete from  products where id='$id'") ;
}
?>
...
function fn_del(id)
{
  ...
  {
	  window.location.href='product.php?action=delete&id='+id;
  }
}
//-->
</script>
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td align="left" valign="middle" class="middle_bg_blu"><h4>Product</h4></td>
                     ...
                     <tr>
                      <td height="12" align="right"><input type="button" value="Add" class="inputBtn2" onclick="window.location ='product_update.php'" /></td>
                    </tr>
                    <tr>
                      <td align="center" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="35%" height="30" class="border_row_left"><strong>Title </strong></td>
                          <td width="30%" height="30" class="border_row_left"><strong>Delete </strong></td>
...
?>
                        <tr>
                          ...
                          <td height="30" class="border_row_right"><a href="product_update.php?id=<?php echo $res['id']; ?>"><span><img src="images/edit_img.jpg" alt="" width="56" height="19" border="0" /></span></a></td>
                        </tr>
<?php
	}
?>   

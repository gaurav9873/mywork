...
if(isset($_REQUEST['action'])&& $_REQUEST["action"]=="delete"){
  $deletequery=mysql_query("delete from  physician where id='".$_GET['id']."'") ;
}
if(isset($_REQUEST['action'])&& $_REQUEST["action"]=="delete_img"){
$sql = "UPDATE physician SET image = '' WHERE id ='".$_REQUEST['id']."' " ;
...
function fn_del(id)
{
  ...
  {
	  window.location.href='physician.php?action=delete&id='+id;
  }
}
function img_del(id)
{
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td align="left" valign="middle" class="middle_bg_blu"><h4>Physicians</h4></td>
                     ...
                     <tr>
                      <td height="12" align="right"><input type="button" value="Add" class="inputBtn2" onclick="window.location ='physician_update.php'" /></td>
                    </tr>
                    <tr>
...
?>
		...
		<img src="../images/physician/<?php echo $res['image']; ?>" width="80" height="100" alt="" border="0" />&nbsp;&nbsp;
		...
		?>
                          ...
                          <td height="30" class="border_row_right"><a href="physician_update.php?id=<?php echo $res['id']; ?>"><span><img src="images/edit_img.jpg" alt="" width="56" height="19" border="0" /></span></a></td>
                        </tr>
<?php
	}
?>   

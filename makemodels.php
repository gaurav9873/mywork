                                ...
                                <form method="post" action="" name="frm1">
                                    ...
                                    <div class="hefp_decide_inner">
                                        <div class="help_form_box">
                                            <label>
                                                <select name="years" id="years" class="help_form_box_form"
                                                        onchange="getmakes(this.value);">
                                                    <?php
                                        ...
                                        <div class="choose_form_box">
                                            <label>
                                                <select name="makes" id="makes" class="choose_box_form"
                                                        onchange="getmodels(this.value);" disabled="disabled">
                                        ...
                                        <div class="choose_form_box">
                                            <label>
                                                <select name="models" id="models" class="choose_box_form"
                                                        disabled="disabled">
                                        ...
                                        <div class="countin">
                                            <input type="image" src="images/continue.jpg" alt="" id="submitimg"

...
if(isset($_POST['submit']) == 'submit'){
	...
	if($doLogin->status == 'login'){
		...
		$msg = 'If you have forgotten your password, please reset your password here: <a href="javascript:void(0);" class="pwdLinks" id="pwdLink">Click here</a>';
	}
}
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
            	...
            	<div class="sec-login lg-form" id="loginsec">
                    ...
                    <form name="loginfrm" id="loginfrm" class="loginfrm" action="" method="post">
						...
						<a href="javascript:void(0);" class="pwdLink pwdLinks" id="pwdLink">Forgot your password?</a>
                 	 </form>               
                </div>
                ...
                <div class="sec-login lg-form" id="forgetpwd" style="display:none;">
					<form name="fpwd" id="fpwd" action="" method="post">
                 	...
                 	<a href="javascript:void(0);" class="pwdLink" id="lgfrmlink">Login</a>                   
                </div>

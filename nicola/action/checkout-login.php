...
if($obj->is_ajax()){
    ...
    $delivery_args = array('post_code' => strtoupper($json->post_code),
        'user_prefix' => isset($json->user_prefix) ? $json->user_prefix : '',
        'user_fname' => $json->user_fname,
        'user_lname' => $json->user_lname,
        'user_mobile' => isset($json->user_mobile) ? $json->user_mobile : '',
        'user_telephone' => isset($json->user_mobile) ? $json->user_mobile : '',
        'user_fax' => isset($json->user_mobile) ? $json->user_mobile : '',
        'delivery_email' => isset($json->delivery_email) ? $json->delivery_email : '',
        'user_city' => $json->user_city,
        'primary_address' => $json->user_address1,
        'secondary_address' => $json->user_address2,
        'user_county' => 'United Kingdom',
        'country' => 'United Kingdom',
        'user_pcode' => strtoupper($json->user_pcode),
        'delivery_date' => $json->delivery_date,
        'user_card_msg' => $json->user_card_msg,
        'user_notes' => isset($json->user_notes) ? $json->user_notes : '',
    ...
    if($addressid){
        ...
        //Insert new address
        $tab_args = array('delivery_address' => json_encode($delivery_args),
            'site_id' => $site_id,
            'user_id' => $_SESSION['user_id'],
            'customer_id' => $_SESSION['customer_id'],

...
<script> var rootUrl = '<?php echo API_PATH; ?>'; </script>
<script>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="billingInformaion">
                    <div class="mandatory" id="mandatory" style="color:red;display:none">Please fill all mandatory
                        fields.
                    </div>
                    <div class="billingform">
                        ...
                        <form name="deliverfrm" id="deliverfrm" class="deliver-form" action="" method="post">
                            <input type="hidden" class="postaction" name="action"
                                   value="<?php echo isset($_SESSION['key']) ? 'saveAddress' : ''; ?>">
                            <input type="hidden" name="addressid"
                                   value="<?php echo $obj->EncryptClientId($address_id); ?>">
                            <div class="billInformation newFormDe ttc">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control validate" name="user_fname" id="user_fname"
                                               value="<?php echo isset($addressval->user_fname) ? $addressval->user_fname : ''; ?>"
                                               placeholder="First Name" type="text">
                                    </div>
                                    <div class="col-sm-3">
                                        <input class="form-control validate" name="user_lname" id="user_lname"
                                               value="<?php echo isset($addressval->user_lname) ? $addressval->user_lname : ''; ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control" name="post_code" id="post_code"
                                               value="<?php echo isset($addressval->post_code) ? $addressval->post_code : ''; ?>"
                                               placeholder="Post Code" type="text" style="text-transform:uppercase"
                                               maxlength="10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control validate" name="user_address1" id="user_address1"
                                               value="<?php echo isset($addressval->primary_address) ? $addressval->primary_address : ''; ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" name="user_address2" id="user_address2"
                                               value="<?php echo isset($addressval->secondary_address) ? $addressval->secondary_address : ''; ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control validate" name="user_city" id="user_city"
                                               value="<?php echo isset($addressval->user_city) ? $addressval->user_city : ''; ?>"
                  ...
                  <div class="col-sm-9">
                    <input class="form-control" name="user_county" id="user_county" value="<?php //echo isset($_SESSION['user_county']) ? $_SESSION['user_county'] : '';?>" placeholder="County" type="text">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control validate user_pcode" name="user_pcode"
                                               id="user_pcode"
                                               value="<?php echo isset($addressval->user_pcode) ? $addressval->user_pcode : ''; ?>"
                                               placeholder="Postcode" style="text-transform:uppercase" maxlength="10"
                                               type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" name="user_mobile" id="user_mobile"
                                               placeholder="Mobile"
                                               value="<?php echo isset($addressval->user_mobile) ? $addressval->user_mobile : ''; ?>"
                                               type="text">
                                    </div>
                                </div>
                  ...
                  <div class="col-sm-9">
                      <input class="form-control" name="user_fax" id="user_fax" placeholder="Fax" value="<?php //echo isset($_SESSION['user_fax']) ? $_SESSION['user_fax'] : ''; ?>" type="text">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" name="delivery_email" id="delivery_email"
                                               placeholder="Email"
                                               value="<?php echo isset($addressval->delivery_email) ? $addressval->delivery_email : ''; ?>"
                                               type="text">
                                    </div>
                                </div>
                            ...
                            <div class="cardMassages formDee frmdee">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="dp1 form-control valid validate" name="delivery_date"
                                           id="delivery_date"
                                           value="<?php echo isset($addressval->delivery_date) ? $addressval->delivery_date : ''; ?>"
                                           readonly placeholder="Delivery Date"/>
                                    <i class="fa fa-calendar"></i>
                                </div>
                                <div class="form-group">
                                    <label for="title"><span>*</span>Card Message :</label>
                                    <textarea name="user_card_msg" id="user_card_msg" class="form-control validate"
                                              cols="15"
                                              role="15"><?php echo isset($addressval->user_card_msg) ? $addressval->user_card_msg : ''; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Note to Florist :</label>
                                    <textarea name="user_notes" id="user_notes" class="form-control"
                                              role="15"><?php echo isset($addressval->user_notes) ? $addressval->user_notes : ''; ?></textarea>
                                </div>

                                <?php if (isset($_SESSION['key'])) { ?>
                                    <button type="button" id="save_delivery_address" value="saveAddress"
                                            class="btn btn-col btnDirection">Proceed
                                    </button>
                                <?php } ?>
                            </div>
                        </form>

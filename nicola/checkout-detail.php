    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="checkoutSummary">
                            ...
                            <section class="checkoutDetail">
                                ...
                                <div class="dateAndCalander">
                                    ...
                                    <div class="calander"><a href="javascript:void(0)"><i class="fa fa-calendar"></i>
                                            (Change Date)</a></div>
                                </div>
                            </section>
                        </div>
                                ...
                                <div class="cardMassages">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3"
                                                  id="messages"><?php echo $card_text; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="instructions">Please enter any delivery instructions(Max 200
                                            Characters) :</label>
                                        <textarea class="form-control" rows="3"
                                                  id="instructions"><?php echo $user_instruction; ?></textarea>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <button type="submit" class="btn btn-col btnDirection" onclick="window.location.href='checkout.php'">
                    Proceed to Billing
                </button>

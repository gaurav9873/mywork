...
<script src="javascripts/billing-address.js"></script>
<script>
                ...
                <div class="responsive-tabs">
                    ...
                    <div>
                        ...
                        <div class="form-group lftBtn">
                            ...
                            <?php }
                            ?>
                            <div class="up-wait" style="display: none; color: #ff441a">Please Wait...</div>
                                ...
                                <form name="change-pass" id="changepass" action="" method="post"
                                    ...
                                    <div class="cardMassages formDee nowidth">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="ch-wait" style="display: none; color: #ff441a">Please
                                                    Wait...
                                                </div>
                ...
                <table style="margin:0;" cellspacing="0" cellpadding="0" border="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td style="width:35%; text-align:left; padding-left:10px;"><a target="_blank"
                                                                                      href="http://54.191.172.136:82/florist-windsor/product-detail?product_id=f85454e81a6">Santorini</a><br>
                            Size :
                        </td>

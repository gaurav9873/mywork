      ...
      <div class="col-lg-12">
        <div class="fixed-header">
          <div class="col-lg-2 col-lg-2 col-md-2 col-sm-2 col-xs-6">
            <div class="logo"><a href="<?php echo SITE_URL; ?>"><img src="images/logo.png" alt="Logo" class="img-responsive" style="max-width: 500px;" /></a></div>
          </div>
          <div class="col-lg-5 col-md-4 col-sm-5">
            <h1 class="quote">Delivery <span>Throughout</span> The UK</h1></div>
          <div class="col-lg-5 col-md-6 col-sm-5 col-xs-6">
            <ul class="callDetail">
              <li><i class="fa fa-phone-square"></i>+44 01189 781177, 795387</li>
              <li></li>

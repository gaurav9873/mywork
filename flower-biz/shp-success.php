...
<section>
    ...
    if (isset($_REQUEST['callbackdata'])) {
        ...
        if ($ord_orderID == $orderid) {
            ...
            $order_args = array('payment_status' => $complete_order,
            ...
            if ($update_stmt) {
                ...
                //Billing Address
                $user_billing_addresss = $dbobj->user_billing_addresss($_SESSION['user_id']);
                ...
                $order_subject = 'Flower Corner order confirmation';
                $order_to = 'orders@nicola.co.uk';
                $order_from = 'orders@nicola.co.uk';
                $order_name = 'Flower Corner';

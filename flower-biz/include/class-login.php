...
class Login
{
    ...
    {
        $sql_query = "SELECT id, user_email, password_txt, site_id, pwd_status FROM op2mro9899_customers_login WHERE user_email = :emailID AND site_id = :site_id";
        try {
    ...
    public function doLogin($user_email, $user_password, $site_id)
    {
        ...
        $sql = "SELECT id, user_email, user_password, user_first_name, user_last_name, unique_key, customer_id, site_id, pwd_status FROM op2mro9899_customers_login WHERE 
            ...
            if (empty($chk_user)) {
                ...
                if ($update_stmt) {
                    ...
                    $msg = '<!doctype html>
								...
								<td height="30" width="20%"><a href="' . $site_url . '" style="font-size:16px; line-height:55px; font-family: latolight, Arial, Helvetica, sans-serif; text-decoration:none; color:#000000;" target="_blank">Home</a></td>
								<td height="30" width="20%"><a href="' . $site_url . 'category-products?category_id=182be0c521" style="font-size:16px; line-height:55px; font-family: latolight, Arial, Helvetica, sans-serif; text-decoration:none; color:#000000;" target="_blank">Autumn Flowers</a></td>
								<td height="30" width="20%"><a href="' . $site_url . 'categories?category_id=c4ca42381" style="font-size:16px; line-height:55px; font-family: latolight, Arial, Helvetica, sans-serif; text-decoration:none; color:#000000;" target="_blank">Core Collection</a></td>
								<td height="30" width="20%"><a href="' . $site_url . 'categories?category_id=38b3eff865" style="font-size:16px; line-height:55px; font-family: latolight, Arial, Helvetica, sans-serif; text-decoration:none; color:#000000;" target="_blank">Occasion</a></td>
								<td height="30" width="20%"><a href="' . $site_url . 'contact-us" style="font-size:16px; line-height:55px; font-family: latolight, Arial, Helvetica, sans-serif; text-decoration:none; color:#000000;" target="_blank">Contact Us</a></td>
								</tr>
								</table></td>
								</tr>
								<tr>
								<td align="center" valign="middle" style="padding:35px 0;">
								<p  style="font-size:24px; line-height:38px; font-family: latolight, Arial, Helvetica, sans-serif; letter-spacing:3px; margin-bottom:0;">Flower Corner, Wokingham are glad to launch their new website.</p>
								...
								<p  style="font-size:24px; line-height:38px; font-family: latolight, Arial, Helvetica, sans-serif; letter-spacing:3px; margin-bottom:0;">For discounts, please use voucher code: ' . $vouchers . '</p>
								...
								<tr>
								<td align="center" valign="middle"><p style="font-size:15px; line-height:22px; font-family: latolight, Arial, Helvetica, sans-serif; text-decoration:none; color:#000000;">&copy; The Flower Corner, UK<br>
                    ...
                    $subj = 'Update your password - Flower Corner';
                    $to = $user_email;
                    $from = 'info@theflowercorner.biz';
                    $name = 'Flower Corner';
                    $obj->password_smtpmailer($to, $from, $name, $subj, $msg);
                    $mailval = json_encode(array('status' => 'update_password', 'pwd_status' => $chk_user[0]->pwd_status));
                    return $mailval;
                }
    ...
    public function get_all_billing_address($user_key, $site_id)
    {
        ...
        if ($unique_key == $user_key) {
            $uid = $auth->id;
            $query = "SELECT id, user_id, site_id FROM op2mro9899_customers_billing_address WHERE user_id = :uid AND site_id = :site_id";
            try {
